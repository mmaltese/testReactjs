                    ...
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto" href="/">
                            <img src="assets/images/logo.png" height="30"
                                witdth="41" alt="Ristorante Con Fusion"/>
                        </NavbarBrand>
                            ...
                            <Nav className="ml-auto" navbar>
                                <NavItem>
                                    <Button outline onClick={this.toggleModal}>
                                        <span className="fa fa-sign-in ga-lg"></span>
                                    </Button>
                                </NavItem>
                            </Nav>
                        </Collapse>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>We take instpiration  the World's best cuisines, and create a unique fusion experience. Our lipsmacking creations will tickle your culinary senses!</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
